...
def query_url(d, api_key):
    ...
    date_str = str(d)
    complete_url = '{}api_key={}&date={}'.format(base_url, api_key, date_str)
    return complete_url
...
def save_image(d, image):
    ...
    file_name = str(d)
    directory_name = '{}/{}'.format(year_str, month_str)
    if not os.path.exists(directory_name):
        os.makedirs(directory_name)
    f = open("{}/{}.jpg".format(directory_name, file_name), "wb")
    f.write(image)
    f.close()
    file_path = '{}/{}.jpg'.format(directory_name, file_name)
    return file_path
...
def main():
    ...
    API_KEY = "w2SaiE5iYn1bhuJG3JYfny0yLr0s46LHfI74gn0c"
